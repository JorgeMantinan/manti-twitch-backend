...
const PHRASES = [
  ...
  "Mirame la cobra",
  "Blacklist es la mejor",
  "Ai se eu chi pego",
  "Tu bebecito",
  "Glogloglo cometelo todo",
  "Bueno basta ya",
  "Que putada dios santo bendito por que",
  "La he cagado la ceo cagada",
  "Te gusta bien duro a a, yo soy la de tu autoescuela esa la de tu esquela a que no te fijabas en mi a a ahora ya te fijas a y ahora yo te digo tra tra",
  "Toma toma toma",
  "Comerme to el pomelo",
  "Como tiene la porongda de chunga y dunga",
  "Aparte de esto gracias a dios",
  "Vamos mancos",
  "Lo que me pueden comer todos aqui",
  "Pero porque no se levanta el doraemon este",
  "Nooooglogloglo que putada",
  "La he cagado",
  "Nunca es tarde para comerse un buen culo",
  "Papii perroo",
  "Por el amor de esa mujer",
  "Noo la puta bala",
  "Que haces eres tonto",
  "Kerry Caberga",
  "Cabron quitate",
  "La Ceocague muy duro",
  "Se puede ser mas torpe",
  "Puto panceta",
  "El ceo acesino vuelve a vuestras casas",
  "Hijo de perra",
  "Cabeza moco ese hijo de la gran putin",
  "Panceta panceta panceta panceta",
  "Quitate de ahi pedazo de cono",
  "Chau chau maravillau",
  "Robo total de verdad que verguenza",
];
